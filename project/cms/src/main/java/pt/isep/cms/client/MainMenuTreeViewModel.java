...
public class MainMenuTreeViewModel implements TreeViewModel {
	...
	private void initializeTree(ShowcaseConstants constants) {
		...
		// Entities.
		{
			...
			category.addCwPanel(new CwTeachers(constants));
			
			category.addCwPanel(new CwStudents(constants));
			
			category.addCwPanel(new CwCMSClasses(constants));
			
			category.addCwPanel(new CwSubjects(constants));
		}
