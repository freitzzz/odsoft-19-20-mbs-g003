...
import pt.isep.cms.classes.client.CMSClassesController;
import pt.isep.cms.classes.client.CwCMSClasses;
...
public interface ShowcaseConstants extends MenuConstants, 
    ...
    TeachersController.CwConstants,
    CwTeachers.CwConstants,
    AddTeacherDialog.CwConstants,
    StudentsController.CwConstants,
    CwStudents.CwConstants,
    AddStudentDialog.CwConstants,
    CMSClassesController.CwConstants,
    CwCMSClasses.CwConstants,
    AddCMSClassDialog.CwConstants,
    SubjectsController.CwConstants,
    CwSubjects.CwConstants,
    AddSubjectDialog.CwConstants{
