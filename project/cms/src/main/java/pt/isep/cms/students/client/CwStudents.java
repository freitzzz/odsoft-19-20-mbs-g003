...
public class CwStudents extends ContentWidget {
	...
	public Widget onInitialize() {
		...
		CMSClassesServiceAsync cmsClassesRpcService = GWT.create(CMSClassesService.class);

		// Should setup the Presenter Panel for the Students....
		VerticalPanel vPanel = new VerticalPanel();

		HandlerManager eventBus = new HandlerManager(null);
		StudentsController appViewer = new StudentsController(rpcService, cmsClassesRpcService, eventBus, this.globalConstants);
		appViewer.go(vPanel);
