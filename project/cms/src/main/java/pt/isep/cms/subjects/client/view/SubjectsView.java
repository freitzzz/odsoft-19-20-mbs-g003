...
public class SubjectsView extends Composite implements SubjectsPresenter.Display {
	...
	public SubjectsView() {
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "subjects-ListContainer");
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "subjects-ListMenu");
		...
		contactsTable.addStyleName("subjects-ListContents");
