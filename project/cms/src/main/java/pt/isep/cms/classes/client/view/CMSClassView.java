...
public class CMSClassView extends Composite implements CMSClassesPresenter.Display {
	...
	public CMSClassView() {
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "cmsClasss-ListContainer");
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "cmsClasss-ListMenu");
		...
		contactsTable.addStyleName("cmsClasss-ListContents");
