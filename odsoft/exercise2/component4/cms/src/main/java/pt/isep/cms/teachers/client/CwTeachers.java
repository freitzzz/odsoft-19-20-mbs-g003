...
/**
 * Main Content Widget for Teachers.
 */
public class CwTeachers extends ContentWidget {
	...
	public static interface CwConstants extends Constants {
		...
		String cwTeachersDescription();

		String cwTeachersName();
	}
	 ...
	 *            the constants
	 */
	public CwTeachers(ShowcaseConstants constants) {
		super(constants.cwTeachersName(), constants.cwTeachersDescription());
	...
	public Widget onInitialize() {
		...
		// Should setup the Presenter Panel for the Teachers....
		VerticalPanel vPanel = new VerticalPanel();

		HandlerManager eventBus = new HandlerManager(null);
		TeachersController appViewer = new TeachersController(rpcService, eventBus, this.globalConstants);
		appViewer.go(vPanel);
